...
const PartnerCompanies = () => {
  return (
    <section className='flex flex-col items-center justify-center my-10 px-10'>
      ...
      <button className='text-gray-100 px-10 py-3 mt-10 border border-gray-100 hover:bg-gray-700'>
        View All Partners
      </button>
